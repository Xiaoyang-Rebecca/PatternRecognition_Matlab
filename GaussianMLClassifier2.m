%write code for GaussianMLClassifier1.m which corresponds to “case 2” discussed in class
% (covariance of all classes is identical but arbitrary)

function [Y_Test] = GaussianMLClassifier2(X_Train, Y_Train, X_Test)
...
%[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[Differenc to GaussianMLClassifier3]]]]]]]]]]]]]]]]]]] 
   ...
   %-----------------------------------------------------------------------
   Y_Test(Idx_test) = find(g_C2 == max(g_C2)); % if gi(x)>gj(x) (for all j ~=i) classify this data as class i
end
